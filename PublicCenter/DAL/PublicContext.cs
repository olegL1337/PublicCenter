...
namespace PublicCenter.DAL
{
    public class PublicContext:DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseNpgsql("Host = localhost; Port = 5432; Database = Public3; Username = postgres; Password = postgres");
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ClientStatus>().HasKey(c => new { c.ClientID, c.StatusId });
            modelBuilder.Entity<ClientTypeOfService>().HasKey(c => new { c.ClientID, c.ServiceTypeID });
