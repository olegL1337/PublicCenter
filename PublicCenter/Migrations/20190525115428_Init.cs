        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Last_name = table.Column<string>(nullable: true),
                    Father_name = table.Column<string>(nullable: true),
                    Formal_address_id = table.Column<int>(nullable: true),
                    Address1ID = table.Column<int>(nullable: true),
                    Real_address_id = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clients_Addresses_Address1ID",
                        column: x => x.Address1ID,
                        principalTable: "Addresses",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Clients_Addresses_Address2ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientTypeOfServices", x => new { x.ClientID, x.ServiceID });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientTypeOfServices_Services_ServiceID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_Address1ID",
                table: "Clients",
                column: "Address1ID");

            migrationBuilder.CreateIndex(
                name: "IX_Clients_Address2ID",
                table: "Clients",
                column: "Address2ID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientTypeOfServices_ServiceID",
